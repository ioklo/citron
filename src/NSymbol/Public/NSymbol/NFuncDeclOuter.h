...
typename std::remove_cvref_t<TVisitor>::ResultType Accept(TVisitor&& v, NFuncDeclOuter* nOuter, TVisitorArgs&&... args)
{
    ...
    if constexpr (std::is_void_v<TResult>)
    {
        struct Bridge : NFuncDeclOuterVisitor {
            ...
            void Visit(NNamespaceDecl* outer) override { call(outer); }
    ...
    else
    {
        struct Bridge : NFuncDeclOuterVisitor {
            ...
            void Visit(NNamespaceDecl* outer) override { result.emplace(call(outer)); }
