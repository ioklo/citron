...
namespace Gum.Test.Metadata
{
    ...
    {   
        ...
        internal VarDef AddVariable(ITypeInst typeInst, string name)
        {
            VarDef varDef = new VarDef(this, typeInst, name);
            children.Add(varDef);
            return varDef;
        }
        
        internal FuncDef AddFunction(string name, int typeVarCount, ITypeInst returnType, IEnumerable<ITypeInst> argTypes)
        {
