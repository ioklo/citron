...
namespace Gum.IR0.Runtime
{
    public class EvaluatorTests
    {
        ...
        LocalVarDeclStmt SimpleLocalVarDecl(string name, TypeId typeId, Exp? initExp)
        {
        ...
        ExpInfo LocalVar(string varName, TypeId typeId)
        ...
        public async Task<(string Output, int RetValue)> EvalAsyncWithRetValue(IEnumerable<Func>? optionalFuncs, IEnumerable<SeqFunc>? optionalSeqFuncs, IEnumerable<Stmt> topLevelStmts)
        {
            // 입력 검사
            IEnumerable<Func> funcs = optionalFuncs ?? Array.Empty<Func>();
            IEnumerable<SeqFunc> seqFuncs = optionalSeqFuncs ?? Array.Empty<SeqFunc>();
            ...
            // SeqFuncId validation
            i = 0;
            foreach(var seqFunc in seqFuncs)
            {
                Assert.Equal(i, seqFunc.Id.Value);
                i++;
            }
            ...
            var script = new Script(Array.Empty<Type>(), funcs ?? Array.Empty<Func>(), seqFuncs ?? Array.Empty<SeqFunc>(), topLevelStmts);
        ...
        public async Task PrivateGlobalVariableExp_GetGlobalValueInFunc()
        {
            ...
            var func0 = new Func(func0Id, false,Array.Empty<string>(), Array.Empty<string>(), new BlockStmt(
            ...
            var topLevelStmts = new Stmt[]
            {
                ...
                new ExpStmt(new ExpInfo(new CallFuncExp(func0Id, Array.Empty<TypeId>(), null, Array.Empty<ExpInfo>()), TypeId.Void))
            };
        ...
        public async Task CallSeqFuncExp_GenerateSequencesInForeach()
        {
            ...
            var seqFunc = new SeqFunc(seqFuncId, TypeId.Int, false, Array.Empty<string>(), new[] { "x", "y" }, new BlockStmt(
            ...
            var stmts = new Stmt[]
            {
                new ForeachStmt(TypeId.Int, "e",
                    new ExpInfo(new CallSeqFuncExp(seqFuncId, Array.Empty<TypeId>(), null, new []{
        ...
        public async Task LocalVarDeclStmt_OverlapsParentScope()
        {
            var stmts = new Stmt[]
            {   
                SimpleLocalVarDecl("x", TypeId.Int, new IntLiteralExp(23)),

                new BlockStmt(

                    SimpleLocalVarDecl("x", TypeId.String, SimpleString("Hello")),
        ...
        public async Task VarDeclForStmtInitializer_DeclaresLocalVariable()
        {
            var stmts = new Stmt[] {
                ...
                SimpleLocalVarDecl("x", TypeId.Int, new IntLiteralExp(34)),
        ...
        public async Task ForStmt_EvalContinueExpAtEndOfBody()
        {
            var stmts = new Stmt[] {
                ...
                SimpleLocalVarDecl("x", TypeId.Bool, new BoolLiteralExp(true)),
        ...
        public async Task ReturnStmt_ExitsFuncImmediately()
        {
            ...
            var func = new Func(funcId, false, Array.Empty<string>(), Array.Empty<string>(),
                new BlockStmt(
                    new ReturnStmt(null),
                    PrintStringCmdStmt("Wrong")
                )
            ...
            var stmts = new Stmt[] { 
                new ExpStmt(new ExpInfo(new CallFuncExp(funcId, Array.Empty<TypeId>(), null, Array.Empty<ExpInfo>()), TypeId.Void)),
                PrintStringCmdStmt("Completed")
            };
        ...
        public async Task ReturnStmt_SetReturnValueToCaller()
        {
            ...
            var stmts = new Stmt[] {
                PrintIntCmdStmt(new CallFuncExp(funcId, Array.Empty<TypeId>(), null, Array.Empty<ExpInfo>())),
            };
        ...
        {
            var stmts = new Stmt[] {
                SimpleLocalVarDecl("x", TypeId.Int, null),
        ...
        public async Task TaskStmt_CapturesLocalVariable()
        {
            ...
            var stmts = new Stmt[] {                
                SimpleLocalVarDecl("count", TypeId.Int, new IntLiteralExp(5)),

                new AwaitStmt(
                    new BlockStmt(
                        new TaskStmt(PrintNumbersStmt(), new CaptureInfo(false, new [] { new CaptureInfo.Element(TypeId.Int, "count") })),
        ...
        public async Task YieldStmt_GenerateElementForInnerMostForeachStmt()
        {
            ...
            var seqFunc0 = new SeqFunc(seqFunc0Id, TypeId.Int, false, Array.Empty<string>(), Array.Empty<string>(),
                new ForeachStmt(TypeId.Int, "elem", new ExpInfo(new CallSeqFuncExp(seqFunc1Id, Array.Empty<TypeId>(), null, Array.Empty<ExpInfo>()), TypeId.Enumerable),
                    new BlockStmt(
            ...
            var seqFunc1 = new SeqFunc(seqFunc1Id, TypeId.Int, false, Array.Empty<string>(), Array.Empty<string>(),
                new BlockStmt(
            ...
            var stmts = new[] {                
                new ForeachStmt(TypeId.Int, "x", new ExpInfo(new CallSeqFuncExp(seqFunc0Id, Array.Empty<TypeId>(), null, Array.Empty<ExpInfo>()), TypeId.Enumerable),
                    PrintIntCmdStmt(new LocalVarExp("x")))
            };
        ...
        public async Task StringExp_ConcatStringsUsingStringExpElements()
        {
            var stmts = new Stmt[]
            {
                SimpleLocalVarDecl("x", TypeId.String, SimpleString("New ")),
        ...
        public async Task AssignExp_ReturnsValue()
        {
            var stmts = new Stmt[]
            {
                SimpleLocalVarDecl("x", TypeId.Int, new IntLiteralExp(3)),
                SimpleLocalVarDecl("y", TypeId.Int, new IntLiteralExp(4)),
        ...
        {
            var printFuncId = new FuncId(0);
            var testFuncId = new FuncId(1);

            var printFunc = new Func(printFuncId, false, Array.Empty<string>(), new[] { "x" },
            ...
            var testFunc = new Func(testFuncId, false, Array.Empty<string>(), new[] { "i", "j", "k" },
            ...
            ExpInfo MakePrintCall(int v) =>
                new ExpInfo(new CallFuncExp(printFuncId, Array.Empty<TypeId>(), null, new[] { new ExpInfo(new IntLiteralExp(v), TypeId.Int) }), TypeId.Int);


            var stmts = new Stmt[]
            {
                new ExpStmt(new ExpInfo(
                    new CallFuncExp(testFuncId, Array.Empty<TypeId>(), null, new [] {
                        MakePrintCall(1),
                        MakePrintCall(2),
                        MakePrintCall(3) }
                    ),
            ...
            var output = await EvalAsync(new[] { printFunc, testFunc }, null, stmts);
        ...
        {
            var funcId = new FuncId(0);
            var func = new Func(funcId, false, Array.Empty<string>(), Array.Empty<string>(), new ReturnStmt(SimpleString("Hello World")));

            var stmts = new Stmt[] { PrintStringCmdStmt(new CallFuncExp(funcId, Array.Empty<TypeId>(), null, Array.Empty<ExpInfo>())) };
        ...
        {
            var seqFuncId = new SeqFuncId(0);
            var seqFunc = new SeqFunc(seqFuncId, TypeId.String, false, Array.Empty<string>(), Array.Empty<string>(), BlankStmt.Instance); // return nothing

            var stmts = new Stmt[]
            {
                // 선언하자 마자 대입하기
                SimpleLocalVarDecl("x", TypeId.Enumerable, new CallSeqFuncExp(seqFuncId, Array.Empty<TypeId>(), null, Array.Empty<ExpInfo>())),

                // TODO: 지금은 value로 얻은 Enumerable을 조작할 수 있는 방법이 없다. foreach에서만 내부적으로 조작할 수 있는데, 그렇게만 하도록 할 것인지 결정을 해야 한다

                // 로컬 변수에 새 값 대입하기
                new ExpStmt(new ExpInfo(new AssignExp(new LocalVarExp("x"), new CallSeqFuncExp(seqFuncId, Array.Empty<TypeId>(), null, Array.Empty<ExpInfo>())), TypeId.Enumerable)),
            };

            await EvalAsync(null, new[] { seqFunc }, stmts);
        ...
        public async Task CallValueExp_EvaluateCallableAndArgumentsInOrder()
        {
            ...
            var makeLambda = new Func(makeLambdaId, false, Array.Empty<string>(), Array.Empty<string>(),
                new BlockStmt(                    
            ...
            var stmts = new Stmt[]
            {
                new ExpStmt(new ExpInfo(
                    new CallValueExp(
                        new ExpInfo(new CallFuncExp(makeLambdaId, Array.Empty<TypeId>(), null, Array.Empty<ExpInfo>()), TypeId.Lambda), 
                        new [] {
                            MakePrintCall(1),
                            MakePrintCall(2),
                            MakePrintCall(3) 
            ...
            var output = await EvalAsync(new[] { printFunc, makeLambda }, null, stmts);
        ...
        public async Task LambdaExp_CapturesLocalVariablesWithCopying()
        {
            var stmts = new Stmt[] {
                SimpleLocalVarDecl("x", TypeId.Int, new IntLiteralExp(3)),
                SimpleLocalVarDecl("func", TypeId.Lambda, new LambdaExp(
                    new CaptureInfo(false, new []{
                        new CaptureInfo.Element(TypeId.Int, "x"),
                    }),
                ...
                new ExpStmt(new ExpInfo(new AssignExp(new LocalVarExp("x"), new IntLiteralExp(34)), TypeId.Int)),
                new ExpStmt(new ExpInfo(new CallValueExp(new ExpInfo(new LocalVarExp("func"), TypeId.Lambda), Array.Empty<ExpInfo>()), TypeId.Void))
            };
        ...
        {
            var stmts = new Stmt[] {
                SimpleLocalVarDecl("list", TypeId.List, new ListExp(TypeId.Int, new [] { new IntLiteralExp(34), new IntLiteralExp(56) })),
                PrintIntCmdStmt(new ListIndexerExp(LocalVar("list", TypeId.List), new ExpInfo(new IntLiteralExp(1), TypeId.Int)))
            };
        ...
        public async Task ListExp_EvaluatesElementExpInOrder()
        {
            ...
            Exp MakePrintCall(int v) =>
                new CallFuncExp(printFuncId, Array.Empty<TypeId>(), null, new[] { new ExpInfo(new IntLiteralExp(v), TypeId.Int) });

            var stmts = new Stmt[] {
                new ExpStmt(new ExpInfo(
                    new ListExp(TypeId.Int, new [] { 
                        MakePrintCall(34),
                        MakePrintCall(56)
                    }),
                    TypeId.List
            ...
            var output = await EvalAsync(new [] { printFunc }, null, stmts);
