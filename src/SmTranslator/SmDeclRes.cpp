...
SmDeclRes ToSmDeclRes(RTypeArguments* outerTypeArgs, RMember member)
{
    struct Visitor
    {
        ...
        SmDeclRes operator()(RMember_EnumElem& member) { return SmDeclRes_EnumElem{member.decl, outerTypeArgs}; }
        SmDeclRes operator()(RMember_EnumElemVar& member) { return SmDeclRes_EnumElemVar{member.decl, outerTypeArgs}; }
        SmDeclRes operator()(RMember_Interface& member) { return SmDeclRes_Interface{outerTypeArgs, member.decl}; }
        SmDeclRes operator()(RMember_Lambda& member) { return SmDeclRes_Lambda{member.decl, outerTypeArgs}; }
        SmDeclRes operator()(RMember_LambdaVar& member) { return SmDeclRes_LambdaVar{member.decl, outerTypeArgs}; }
