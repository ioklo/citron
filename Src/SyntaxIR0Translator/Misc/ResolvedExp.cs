...
abstract record class ResolvedExp
{
    ...
    public abstract IType GetExpType(R.IBuiltInTypeProvider provider);
    ...
    public record class ThisVar(IType Type) : ResolvedExp
    {
        ...
        public override IType GetExpType(R.IBuiltInTypeProvider provider) { return Type; }
    }
    ...
    public record class LambdaMemberVar(LambdaMemberVarSymbol Symbol) : ResolvedExp
    {
        ...
        public override IType GetExpType(R.IBuiltInTypeProvider provider) { return Symbol.GetDeclType(); }
    }
    ...
    public record class LocalDeref(ResolvedExp Target) : ResolvedExp
    {
        ...
        public override IType GetExpType(R.IBuiltInTypeProvider provider) { return ((LocalPtrType)Target.GetExpType(provider)).GetInnerType(); }
    }
    ...
    public record class BoxDeref(ResolvedExp Target) : ResolvedExp
    {
        ...
        public override IType GetExpType(R.IBuiltInTypeProvider provider) { return ((BoxPtrType)Target.GetExpType(provider)).GetInnerType(); }
    }
    ...
    public record class ListIndexer(ResolvedExp Instance, R.Exp Index, IType ItemType) : ResolvedExp
    {
        ...
        public override IType GetExpType(R.IBuiltInTypeProvider provider) { return ItemType; }
    }
    ...
    public record class IR0Exp(R.Exp Exp) : ResolvedExp
    {
        ...
        public override IType GetExpType(R.IBuiltInTypeProvider provider) { return Exp.GetExpType(provider); }
    }
}
