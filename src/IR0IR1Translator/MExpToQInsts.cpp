...
//expected<void, DiagPtr> EmitInitLValue(size_t destPtrSlotIndex, size_t srcSlotIndex, RType* type, QTranslationContexts& contexts)
//{
//    // 1. primitive인지 확인
...
//}
//
//expected<void, DiagPtr> EmitInitLValuePtr(size_t destPtrSlotIndex, size_t srcPtrSlotIndex, RType* type, QTranslationContexts& contexts)
//{
//    // 1. primitive인지 확인
//    if (auto* primitiveType = dynamic_cast<RType_Primitive*>(type))
//    {
...
//
//public:
//    MExpQInstsTranslator(optional<size_t> o_destSlotIndex, QTranslationContexts& contexts)
//        : o_destSlotIndex{o_destSlotIndex}, contexts{contexts}
//    {
//    }
//
//    // load(loc),
...
//        auto e_srcLoc = TranslateMLocToQInsts(exp->loc, bodyContext);
...
//                auto e_src = TranslateMReadToQInsts(exp->src, bodyContext);
//                RETURN_ON_ERROR(e_src);
//
//                return visit([](auto& src) -> expected<void, DiagPtr> {
//                    using U = remove_cvref_t<decltype(src)>;
//
//                    if constexpr (same_as<U, QLocResult_Slot>) // src가 slot이면, 1:1로 복사를 합니다
//                    {
//                        auto* type = exp->src->GetType();
//                        auto e_emitResult = bodyContext.EmitInst(QInst_Assign{type, QArg_Slot{destLoc.slotIndex}, QArg_Slot{src.slotIndex}});
...
//    {
//        if (o_destSlotIndex)
//            return TranslateMInitExp_StringToQInsts(exp, *o_destSlotIndex, bodyContext);
//
//        return TranslateMInitExp_StringToQInsts(exp, nullopt, bodyContext);
//    }
//
...
//            {MInternalUnaryOperator::LogicalNot_Bool_Bool, QInst_IntrinsicKind::LogicalNot_Bool_Bool},
//            {MInternalUnaryOperator::UnaryMinus_Int_Int, QInst_IntrinsicKind::UnaryMinus_Int_Int},
...
//            {MInternalUnaryAssignOperator::PrefixInc_Int_Int, QInst_IntrinsicKind::PrefixInc_Int_Int},
//            {MInternalUnaryAssignOperator::PrefixDec_Int_Int, QInst_IntrinsicKind::PrefixDec_Int_Int},
//            {MInternalUnaryAssignOperator::PostfixInc_Int_Int, QInst_IntrinsicKind::PostfixInc_Int_Int},
//            {MInternalUnaryAssignOperator::PostfixDec_Int_Int, QInst_IntrinsicKind::PostfixDec_Int_Int},
//        };
//
//        auto i = m.find(exp->op);
//        assert(i != m.end());
...
//            {MInternalBinaryOperator::Multiply_Int_Int_Int, QInst_IntrinsicKind::Multiply_Int_Int_Int},
//            {MInternalBinaryOperator::Divide_Int_Int_Int, QInst_IntrinsicKind::Divide_Int_Int_Int},
//            {MInternalBinaryOperator::Modulo_Int_Int_Int, QInst_IntrinsicKind::Modulo_Int_Int_Int},
//            {MInternalBinaryOperator::Add_Int_Int_Int, QInst_IntrinsicKind::Add_Int_Int_Int},
//            {MInternalBinaryOperator::Add_String_String_String, QInst_IntrinsicKind::Add_String_String},
//            {MInternalBinaryOperator::Subtract_Int_Int_Int, QInst_IntrinsicKind::Subtract_Int_Int_Int},
//            {MInternalBinaryOperator::LessThan_Int_Int_Bool, QInst_IntrinsicKind::LessThan_Int_Int_Bool},
//            {MInternalBinaryOperator::LessThan_String_String_Bool, QInst_IntrinsicKind::LessThan_String_String_Bool},
//            {MInternalBinaryOperator::GreaterThan_Int_Int_Bool, QInst_IntrinsicKind::GreaterThan_Int_Int_Bool},
//            {MInternalBinaryOperator::GreaterThan_String_String_Bool, QInst_IntrinsicKind::GreaterThan_String_String_Bool},
//            {MInternalBinaryOperator::LessThanOrEqual_Int_Int_Bool, QInst_IntrinsicKind::LessThanOrEqual_Int_Int_Bool},
//            {MInternalBinaryOperator::LessThanOrEqual_String_String_Bool, QInst_IntrinsicKind::LessThanOrEqual_String_String_Bool},
//            {MInternalBinaryOperator::GreaterThanOrEqual_Int_Int_Bool, QInst_IntrinsicKind::GreaterThanOrEqual_Int_Int_Bool},
//            {MInternalBinaryOperator::GreaterThanOrEqual_String_String_Bool, QInst_IntrinsicKind::GreaterThanOrEqual_String_String_Bool},
//            {MInternalBinaryOperator::Equal_Int_Int_Bool, QInst_IntrinsicKind::Equal_Int_Int_Bool},
//            {MInternalBinaryOperator::Equal_Bool_Bool_Bool, QInst_IntrinsicKind::Equal_Bool_Bool_Bool},
//            {MInternalBinaryOperator::Equal_String_String_Bool, QInst_IntrinsicKind::Equal_String_String_Bool},
//        };
//
//        auto i = m.find(exp->op);
//        assert(i != m.end());
