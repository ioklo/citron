export module Citron.NDecls:NStmt;
...
export class NStmt_Command : public NStmt
{
public:
...
// 로컬 변수는 
export class NStmt_LocalVarDecl : public NStmt
{
public:
    RTypePtr type;
    std::string name;
...
export class NStmt_If : public NStmt
{
public:
    NExpPtr cond;
...
export class NStmt_IfNullableRefTest : public NStmt
{
public:
    RTypePtr refType;
    RName varName;
...
export class NStmt_IfNullableValueTest : public NStmt
{
public:
    RTypePtr type;
    RName varName;
...
export class NStmt_For : public NStmt
{
public:
...
export class NStmt_Continue : public NStmt
{
public:
...
export class NStmt_Break : public NStmt
{
public:
    IR0_API NStmt_Break();
    void Accept(NStmtVisitor& visitor) override { visitor.Visit(*this); }
...
export class NStmt_Return : public NStmt
{
public:
    NExpPtr exp;
public:
...
export class NStmt_Block : public NStmt
{
public:
...
export class NStmt_Blank : public NStmt
{
public:
    IR0_API NStmt_Blank();
    void Accept(NStmtVisitor& visitor) override { visitor.Visit(*this); }
...
export class NStmt_Exp : public NStmt
{
public:
    NExpPtr exp;
public:
...
export class NStmt_Task : public NStmt
{
public:
...
export class NStmt_Await : public NStmt
{
public:
    std::vector<NStmtPtr> body;
public:
...
export class NStmt_Async : public NStmt
{
public:
    std::shared_ptr<NLambdaDecl> lambdaDecl;
    std::vector<NArgument> captureArgs;
...
export class NStmt_Foreach : public NStmt
{
public:
...
export class NStmt_ForeachCast : public NStmt
{
public:
    NExpPtr enumeratorExp;
    RTypePtr itemType;
...
export class NStmt_Yield : public NStmt
{
public:
    NExpPtr value;
public:
...
export class NStmt_CallClassCtor : public NStmt
{
public:
...
export class NStmt_CallStructCtor : public NStmt
{
public:
...
export class NStmt_NullDirective : public NStmt
{
public:
    NLocPtr loc;
public:
...
export class NStmt_NotNullDirective : public NStmt
{
public:
    NLocPtr loc;
public:
...
export class NStmt_StaticNullDirective : public NStmt
{
public:
    NLocPtr loc;
public:
...
export class NStmt_StaticNotNullDirective : public NStmt
{
public:
    NLocPtr loc;
public:
...
export class NStmt_StaticUnknownNullDirective : public NStmt
{
public:
    NLocPtr loc;
public:
