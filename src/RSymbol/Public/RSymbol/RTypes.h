...
public:
    ...
    virtual std::optional<RDeclRes> GetMember(InRef<RName> name, size_t explicitMemberTypeArgsCount) = 0;
...
public:
    ...
    RSYMBOL_API std::optional<RDeclRes> GetMember(InRef<RName> name, size_t explicitMemberTypeArgsCount) override;
...
public:
    ...
    std::optional<RDeclRes> GetMember(InRef<RName> name, size_t explicitMemberTypeArgsCount) override { return std::nullopt; }
