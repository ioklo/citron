...
public:
    ...
    RSYMBOL_API void Init(RDeclKey&& key, RThisKind&& thisKind, RFuncReturn&& funcRet, std::vector<RTypeParam*>&& typeParams, std::vector<RFuncParameter>&& funcParameters, bool bLastParameterVariadic);
