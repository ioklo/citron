...
struct MCallable_ClassCtor { RClassCtorDecl* decl; RTypeArguments* typeArgs; }; // constructor에서 base ctor호출시 사용
struct MCallable_ClassFunc { RClassFuncDecl* decl; RTypeArguments* typeArgs; MLoc* instance; }; // c.F();
struct MCallable_StructCtor { RStructCtorDecl* decl; RTypeArguments* typeArgs; }; // constructor에서 base ctor호출시 사용
