...
{
    class GenerateTypedAbstractSyntax
    {
        ...
        static public void GenerateCSharpFile()
        {
            ...
            // Src
            using(var streamWriter = new StreamWriter(@"..\..\Src\Gum.Lang\TypedAbstractSyntax\Generated.cs"))
            {
                var printer = new CSharpPrinter("Gum.Lang.TypedAbstractSyntax");
