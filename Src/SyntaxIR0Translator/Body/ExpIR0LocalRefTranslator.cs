...
struct ExpIR0LocalRefTranslator : S.IExpVisitor<TranslationResult<R.Exp>>
{
    ScopeContext context;
    IType? innerHintType;

    ExpIR0LocalRefTranslator(ScopeContext context, IType? innerHintType)
    {
    ...
    public static TranslationResult<R.Exp> Translate(S.Exp expSyntax, ScopeContext context, IType? innerHintType) // throws FatalErrorException
    {
        ...
        // var visitor = new ExpIR0LocalRefTranslator(context, innerHintType);
        // return expSyntax.Accept<ExpIR0LocalRefTranslator, R.Exp>(ref visitor);
    }
