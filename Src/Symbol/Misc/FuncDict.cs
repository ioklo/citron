...
namespace Citron.Symbol
{
    public class FuncDict
    {
        ...
        {
            var funcsDict = new Dictionary<(Name Name, int TypeParamCount), List<TFuncDeclSymbol>>();
            ...
            // funcsDict제작이 다 끝났으면
            var builder = ImmutableDictionary.CreateBuilder<(Name Name, int TypeParamCount), ImmutableArray<TFuncDeclSymbol>>();
    ...
    public partial struct FuncDict<TFuncDeclSymbol>
        where TFuncDeclSymbol : IDeclSymbolNode
    {
        internal ImmutableDictionary<(Name Name, int TypeParamCount), ImmutableArray<TFuncDeclSymbol>> funcs;
        internal ImmutableDictionary<DeclSymbolNodeName, TFuncDeclSymbol> exactFuncs;
        
        public ImmutableArray<TFuncDeclSymbol> Get(Name name, int minTypeParamCount)
        {
