...
std::expected<NExp*, DiagPtr> TranslateSBoolLiteralExpToNExp(SExp_BoolLiteral* exp, TranslationContext& context);
std::expected<NExp*, DiagPtr> TranslateSIntLiteralExpToNExp(SExp_IntLiteral* exp, TranslationContext& context);
