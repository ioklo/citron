...
Date: 2026-08-15
Status: superseded by the 2026-08-20 generic application composition decision

## Superseded Direction

이 문서는 2026-08-15 시점의 `SmTypeView`/lazy substitution 후보안을 보존하는
history note다. 2026-08-20 후속 논의에서 `RAppliedDecl`의 complete type arguments
자체를 substitution 정규형으로 사용하고, 뒤 substitution을 arguments에 합성하면
별도 lazy view가 필요하지 않다고 결론 내렸다. 현재 결정은
`ai/notes/2026-08-20-generic-application-composition-and-smtype-removal.md`와
`ai/wiki/compiler/declaration-model.md`를 따른다.
...
they were not the current design authority even at this discussion stage. The
`SmTypeView` replacement proposed below was later superseded by the 2026-08-20
complete-arguments composition decision.
...
## Direction At The Time: Explicit Lazy Substitution
