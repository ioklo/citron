export module Citron.SyntaxIR0Translator:FuncContext;
...
export struct NLambdaVarAndArg
{
...
// 람다인 경우
export class FuncContext_Lambda : public FuncContext
{
...
// FuncDecl인 경우
export class FuncContext_FuncDecl : public FuncContext
{
