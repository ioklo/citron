...
using MClassPtr = std::shared_ptr<class MClass>;
using MClassMemberVarPtr = std::shared_ptr<class MClassMemberVar>;
using MClassConstructorPtr = std::shared_ptr<class MClassConstructor>;
using MClassMemberFuncPtr = std::shared_ptr<class MClassMemberFunc>;
using MStructMemberVarPtr = std::shared_ptr<class MStructMemberVar>;
using MStructConstructorPtr = std::shared_ptr<class MStructConstructor>;
using MStructMemberFuncPtr = std::shared_ptr<class MStructMemberFunc>;
using MEnumPtr = std::shared_ptr<class MEnum>;
using MEnumElemPtr = std::shared_ptr<class MEnumElem>;
using MEnumElemMemberVarPtr = std::shared_ptr<class MEnumElemMemberVar>;
using MGlobalFuncPtr = std::shared_ptr<class MGlobalFunc>;
using MTypePtr = std::shared_ptr<class MType>;
using MFuncTypePtr = std::shared_ptr<class MFuncType>;
using MLambdaPtr = std::shared_ptr<class MLambda>;
...
{
    MClassConstructorPtr constructor;
    std::vector<RArgument> args;
public:
    void Accept(RExpVisitor& visitor) override { visitor.Visit(*this); }
};
...
{
    MClassMemberFuncPtr classMemberFunc;
    RLocPtr instance;
    std::vector<RArgument> args;
public:
    void Accept(RExpVisitor& visitor) override { visitor.Visit(*this); }
...
{
    RExpPtr src;
    MClassPtr _class; // MType이 아니라도 괜찮은가
public:
    void Accept(RExpVisitor& visitor) override { visitor.Visit(*this); }
};
...
{
    MStructConstructorPtr constructor;
    std::vector<RArgument> args;
public:
    void Accept(RExpVisitor& visitor) override { visitor.Visit(*this); }
};
...
{
    MStructMemberFuncPtr structMemberFunc;
    RLocPtr instance;
    std::vector<RArgument> args;
public:
    void Accept(RExpVisitor& visitor) override { visitor.Visit(*this); }
