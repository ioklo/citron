...
struct Error_VarDecl_MismatchBetweenRefDeclTypeAndRefInitType : Error { }; // A0102_VarDecl_MismatchBetweenRefDeclTypeAndRefInitType
struct Error_VarDecl_LocalVarNameShouldBeUniqueWithinScope : Error { }; // A0103_VarDecl_LocalVarNameShouldBeUniqueWithinScope
struct Error_VarDecl_GlobalVariableNameShouldBeUnique : Error { }; // A0104_VarDecl_GlobalVariableNameShouldBeUnique
struct Error_VarDecl_RefDeclNeedInitializer : Error { }; // A0106_VarDecl_RefDeclNeedInitializer
...
struct Error_UnaryOp_UnaryMinusOperatorIsAppliedToIntTypeOperandOnly : Error { }; // A0702_UnaryOp_UnaryMinusOperatorIsAppliedToIntTypeOperandOnly
struct Error_BinaryOp_OperatorNotFound : Error { }; // A0802_BinaryOp_OperatorNotFound
struct Error_BinaryOp_LeftOperandIsNotAssignable : Error { }; // A0803_BinaryOp_LeftOperandIsNotAssignable
struct Error_CallExp_MultipleCandidates : Error { }; // A0901_CallExp_MultipleCandidates
struct Error_CallExp_CallableExpressionIsNotCallable : Error { }; // A0902_CallExp_CallableExpressionIsNotCallable
struct Error_CallExp_MismatchEnumCtorArgCount : Error { }; // A0903_CallExp_MismatchEnumCtorArgCount
struct Error_CallExp_MismatchBetweenEnumParamTypeAndEnumArgType : Error { }; // A0904_CallExp_MismatchBetweenEnumParamTypeAndEnumArgType
struct Error_CallExp_NoMatchedStructCtorFound : Error { }; // A0905_CallExp_NoMatchedStructCtorFound // TODO: A2602_NewExp_NoCtorFound 랑 겹침
struct Error_CallExp_NotFound : Error { }; // A0906_CallExp_NotFound
struct Error_CallExp_MultipleMatchedStructCtors : Error { }; // A0907_CallExp_MultipleMatchedStructCtors
struct Error_CallExp_InstanceIsNotLocation : Error { }; // A0908_CallExp_InstanceIsNotLocation
struct Error_IfStmt_ConditionShouldBeBool : Error { }; // A1001_IfStmt_ConditionShouldBeBool
struct Error_IfTestStmt_CantDowncast : Error { }; // A2301_IfTestStmt_CantDowncast
struct Error_ForStmt_ConditionShouldBeBool : Error { }; // A1101_ForStmt_ConditionShouldBeBool
struct Error_ForStmt_ExpInitializerShouldBeAssignOrCall : Error { }; // A1102_ForStmt_ExpInitializerShouldBeAssignOrCall
struct Error_ForStmt_ContinueExpShouldBeAssignOrCall : Error { }; // A1103_ForStmt_ContinueExpShouldBeAssignOrCall
struct Error_ReturnStmt_MismatchBetweenReturnValueAndFuncReturnType : Error { }; // A1201_ReturnStmt_MismatchBetweenReturnValueAndFuncReturnType
struct Error_ReturnStmt_SeqFuncShouldReturnVoid : Error { }; // A1202_ReturnStmt_SeqFuncShouldReturnVoid
struct Error_ReturnStmt_RefTargetIsNotLocation : Error { }; // A1203_ReturnStmt_RefTargetIsNotLocation
struct Error_ExpStmt_ExpressionShouldBeAssignOrCall : Error { }; // A1301_ExpStmt_ExpressionShouldBeAssignOrCall
struct Error_YieldStmt_YieldShouldBeInSeqFunc : Error { }; // A1401_YieldStmt_YieldShouldBeInSeqFunc
struct Error_ContinueStmt_ShouldUsedInLoop : Error { }; // A1501_ContinueStmt_ShouldUsedInLoop
struct Error_BreakStmt_ShouldUsedInLoop : Error { }; // A1601_BreakStmt_ShouldUsedInLoop
struct Error_ListExp_CantInferElementTypeWithEmptyElement : Error { }; // A1701_ListExp_CantInferElementTypeWithEmptyElement
struct Error_ListExp_MismatchBetweenElementTypes : Error { }; // A1702_ListExp_MismatchBetweenElementTypes
struct Error_ForeachStmt_IteratorShouldBeListOrEnumerable : Error { }; // A1801_ForeachStmt_IteratorShouldBeListOrEnumerable // TODO: 추후에 더 일반적으로 바뀌어야 한다
struct Error_ForeachStmt_MismatchBetweenElemTypeAndIteratorElemType : Error { }; // A1802_ForeachStmt_MismatchBetweenElemTypeAndIteratorElemType
struct Error_StringExp_ExpElementShouldBeBoolOrIntOrString : Error { }; // A1901_StringExp_ExpElementShouldBeBoolOrIntOrString // TODO: 보다 일반적으로 바뀌어야 한다. ToString을 구현한 애들이 가능
struct Error_ResolveIdentifier_MultipleCandidatesForIdentifier : Error { }; // A2001_ResolveIdentifier_MultipleCandidatesForIdentifier
struct Error_ResolveIdentifier_VarWithTypeArg : Error { }; // A2002_ResolveIdentifier_VarWithTypeArg
struct Error_ResolveIdentifier_CantGetStaticMemberThroughInstance : Error { }; // A2003_ResolveIdentifier_CantGetStaticMemberThroughInstance // instance에서 static 함수, 변수를 가지고 오려고 했을 때, e.F, e.v (F, v가 static인 경우)
struct Error_ResolveIdentifier_CantGetTypeMemberThroughInstance : Error { }; // A2004_ResolveIdentifier_CantGetTypeMemberThroughInstance   // instance에서 타입을 가지고 오려고 했을 때, e.T
struct Error_ResolveIdentifier_CantGetInstanceMemberThroughType : Error { }; // A2005_ResolveIdentifier_CantGetInstanceMemberThroughType
struct Error_ResolveIdentifier_FuncCantHaveMember : Error { }; // A2006_ResolveIdentifier_FuncCantHaveMember
struct Error_ResolveIdentifier_NotFound : Error { }; // A2007_ResolveIdentifier_NotFound
struct Error_ResolveIdentifier_CantUseTypeAsExpression : Error { }; // A2008_ResolveIdentifier_CantUseTypeAsExpression // Type으로 Resolve는 되지만, 값으로 변경하려고 시도하다가 에러 var x = X.Y;
struct Error_ResolveIdentifier_EnumElemCantHaveMember : Error { }; // A2009_ResolveIdentifier_EnumElemCantHaveMember
struct Error_ResolveIdentifier_ThisIsNotInTheContext : Error { }; // A2010_ResolveIdentifier_ThisIsNotInTheContext   // 
struct Error_ResolveIdentifier_TryAccessingPrivateMember : Error { }; // A2011_ResolveIdentifier_TryAccessingPrivateMember
struct Error_ResolveIdentifier_EnumInstanceCantHaveMember : Error { }; // A2013_ResolveIdentifier_EnumInstanceCantHaveMember
struct Error_ResolveIdentifier_CantUseNamespaceAsExpression : Error { }; // A2013_ResolveIdentifier_CantUseNamespaceAsExpression // 네임스페이스를 exp로 쓸 수 없습니다        
...
struct Error_StructDecl_CannotSetMemberProtectedAccessBecauseItsNotAllowed : Error { }; // A2402_StructDecl_CannotSetMemberProtectedAccessBecauseItsNotAllowed
struct Error_StructDecl_CannotDeclCtorDifferentWithTypeName : Error { }; // A2403_StructDecl_CannotDeclCtorDifferentWithTypeName
struct Error_ClassDecl_CannotSetMemberPrivateAccessExplicitlyBecauseItsDefault : Error { }; // A2501_ClassDecl_CannotSetMemberPrivateAccessExplicitlyBecauseItsDefault
struct Error_ClassDecl_CannotDeclCtorDifferentWithTypeName : Error { }; // A2502_ClassDecl_CannotDeclCtorDifferentWithTypeName
struct Error_ClassDecl_CannotFindBaseClassCtor : Error { }; // A2503_ClassDecl_CannotFindBaseClassCtor
struct Error_ClassDecl_CannotAccessBaseClassCtor : Error { }; // A2504_ClassDecl_CannotAccessBaseClassCtor
struct Error_ClassDecl_TryCallBaseCtorWithoutBaseClass : Error { }; // A2505_ClassDecl_TryCallBaseCtorWithoutBaseClass
struct Error_ClassDecl_CannotDecideWhichBaseCtorUse : Error { }; // A2506_ClassDecl_CannotDecideWhichBaseCtorUse
struct Error_NewExp_TypeIsNotClass : Error { }; // A2601_NewExp_TypeIsNotClass
struct Error_NewExp_NoMatchedClassCtor : Error { }; // A2602_NewExp_NoMatchedClassCtor // TODO: LOGGING_API void Fatal_CallExp_NoConstructorFound(); // A0905_CallExp_NoConstructorFound 랑 겹침
struct Error_NewExp_MultipleMatchedClassCtors : Error { }; // A2603_NewExp_MultipleMatchedClassCtors // TODO: LOGGING_API void Fatal_CallExp_NoCtorFound(); // A0905_CallExp_NoConstructorFound 랑 겹침
struct Error_NullLiteralExp_CantInferNullableType : Error { }; // A2701_NullLiteralExp_CantInferNullableType // null은 힌트와 쓰인다
struct Error_StaticNotNullDirective_ShouldHaveOneArgument : Error { }; // A2801_StaticNotNullDirective_ShouldHaveOneArgument
struct Error_StaticNotNullDirective_ArgumentMustBeLocation : Error { }; // A2802_StaticNotNullDirective_ArgumentMustBeLocation
struct Error_Reference_CantMakeReference : Error { }; // A3001_Reference_CantMakeReference
