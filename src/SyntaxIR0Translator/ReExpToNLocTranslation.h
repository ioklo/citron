...
std::expected<NLoc*, DiagPtr> TranslateReLocalVarExpToNLoc(ReExp_LocalVar& reExp);
std::expected<NLoc*, DiagPtr> TranslateReLambdaVarExpToNLoc(ReExp_LambdaVar& reExp);
