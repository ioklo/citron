...
namespace Gum.IR0
{
    ...
    {   
        ...
        {
            VisitTypeArgExpsNoReturn(idExp.TypeArgs);
        }
        ...
        void VisitCallExp(S.CallExp callExp)
        {
            ...
            VisitTypeArgExpsNoReturn(callExp.TypeArgs);
        ...
        void VisitMemberCallExp(S.MemberCallExp memberCallExp)
        {
            ...
            VisitTypeArgExpsNoReturn(memberCallExp.MemberTypeArgs);
        ...
        void VisitMemberExp(S.MemberExp memberExp)
        {
            ...
            VisitTypeArgExpsNoReturn(memberExp.MemberTypeArgs);
        }

        void VisitListExp(S.ListExp listExp)
        {
            if (listExp.ElemType != null)
                VisitTypeExpNoThrow(listExp.ElemType);
