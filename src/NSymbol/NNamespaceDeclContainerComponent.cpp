...
void NNamespaceDeclContainerComponent::AddNamespace(NNamespaceDecl* _namespace)
{
    namespaceDecls.push_back(_namespace);
    namespaceDict.insert_or_assign(_namespace->GetName(), _namespace);
}

NNamespaceDecl* NNamespaceDeclContainerComponent::GetNamespace(const std::string& name)
{
