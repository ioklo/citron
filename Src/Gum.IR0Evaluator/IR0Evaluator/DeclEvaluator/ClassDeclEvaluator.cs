...
using R = Gum.IR0;
using static Gum.IR0.PathExtensions;
...
namespace Gum.IR0Evaluator
{
        struct ClassDeclEvaluator
        {
            ...
            public static void Eval(IR0GlobalContext globalContext, ItemContainer parentContainer, R.Path.Normal curPath, int totalTypeParamCount, R.ClassDecl classDecl)
            {
            ...
            ClassDeclEvaluator(IR0GlobalContext globalContext, R.Path.Nested classPath, int totalTypeParamCount, ItemContainer classContainer, R.ClassDecl classDecl)
            {
